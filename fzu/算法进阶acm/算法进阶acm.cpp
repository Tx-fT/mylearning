...
//#include<iostream>
//using namespace std;
//typedef long long LL;  // ���� LL Ϊ long long
//
//int n,m;
//LL a[4*100005];      // �߶�������
//LL h[100005];        // ԭʼ����
...
//}
//
//void maketag(int idx,int len,LL x){  // x ��Ϊ LL ����
//    lzy[idx]+=x;
//    a[idx]+=len*x;
//}
//
...
//}
//
//LL query2(int l1,int r1,int l,int r,int idx){  // �������͸�Ϊ LL
//    if(inrange(l1,r1,l,r)){
//        return a[idx];
//    }
//    else if(!outrange(l1,r1,l,r)){
...
//}
//
//void update1(int l1,int r1,int l,int r,LL x,int idx){  // x ��Ϊ LL ����
//    if(inrange(l1,r1,l,r)){
//        maketag(idx,r-l+1,x);
//        return;
//    }
